...
export const Contact = ({ contact }) => {
  ...
  return (
    <section
      ref={contact}
      className="w-full flex flex-col gap-8 lg:gap-14 items-center pb-8 bg-bg-primary pt-28 lg:pt-44 min-h-screen px-4"
    >
      ...
      <div className="w-full flex flex-col items-center">
        ...
        {contactInfoTab && (
          <div className="flex flex-col rounded-lg py-6 px-6 gap-8 items-center w-full max-w-sm lg:max-w-xl bg-black-75 text-slate-200">
            ...
            >
              <button className="bg-secondary rounded-lg px-4 py-4 w-full flex items-center justify-center gap-6">
                Call Me
                <img
            ...
            <a
              ...
              className="w-full"
            >
              <button className="bg-red-700 rounded-lg px-4 py-4 w-full flex items-center justify-center gap-6">
                Email Me
                <img
            ...
            <a
              ...
              className="w-full"
            >
              <button className="bg-blue-500 rounded-lg px-4 py-4 w-full flex items-center justify-center gap-6">
                Visit My LinkedIn
                <img
            ...
            <a
              ...
              className="w-full"
            >
              <button className="bg-green-600 rounded-lg px-4 py-4 w-full flex items-center justify-center gap-6">
                WhatsApp Me
                <img
          ...
          <div className="flex flex-col rounded-lg p-4 gap-4 w-full items-center max-w-xl bg-black-75">
            ...
            <form className="w-full px-4" onSubmit={sendEmail} ref={form}>
              ...
              <textarea
                ...
                onChange={handleChange}
              />
              <button className="bg-primary text-slate-50 font-semibold px-4 py-2 rounded-md hover:bg-slate-500 focus:bg-slate-400 mt-2">
                Send
              </button>
            </form>
          </div>
