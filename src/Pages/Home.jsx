...
export const Home = ({ home }) => {
  ...
  return (
    <section
      ref={home}
      className="pt-32 sm:pt-44 min-h-screen bg-bg-primary flex flex-col items-center gap-8"
    >
      ...
      <h1 className="text-xl sm:text-2xl">
        My name is <span className="font-bold">Daniel</span> and I&apos;m a{" "}
      </h1>
      <span className="text-color-blocker underline text-3xl sm:text-4xl">
        Front-End Developer
      </span>
