...
export const About = ({ about }: AboutProps) => {
	...
	return (
		<section
			ref={about}
			className="flex flex-col gap-8 items-center pt-28 min-h-screen px-4 pb-8 lg:justify-center"
		>
			...
			<div className="bg-black-75 rounded-sm flex flex-col items-center gap-4 px-3 py-2 lg:flex-row lg:items-start max-w-2xl">
				<div className="flex flex-col gap-3 w-full items-start">
					...
					<p className="text-slate-50 ">
						My name is , Daniel Mpho Mankanda and I&apos;m a 29 year-old front
						end developer from the Far East Rand of Johannesburg.
					</p>
					{fullAboutMe && (
						<p className="text-slate-50 ">
					...
					<p className="text-slate-50 ">
						...
						better - one programme at a time. If that sounds like you, I&apos;d
